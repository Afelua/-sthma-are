...
echo "<div class=\"container\">";
	echo "<div class=\"subpage_area\">\n";
		echo "<div class=\"span-18 notopmargin\">\n";
			echo "<h2 class=\"subpage_title colored\">Школьная программа по биологии</h2>\n";
		echo "</div>\n";
	echo "</div>\n";
...
/*		echo "<div class=\"span-16 blog2 notopmargin\">\n";
			echo "<div>\n";
				...
				echo "<div class=\"span-8 last\">\n";
					echo "<h4 class=\"block_header\">Базовый курс</h4>\n";
			...
			echo "<div>\n";
				...
				echo "<div class=\"span-8 last\">\n";
					echo "<h4 class=\"block_header\">Углублённый курс</h4>\n";
		...
		echo "<div class=\"side_bar\">\n";
			echo "<div class=\"side_bar_widget notopmargin\">\n";
				...
				echo "<h5><span class=\"colored bold\">30 мин</span> | Обсуждение новой темы</h5>\n";
