...
if(isset($_GET['lev'])){
	switch($_GET['lev']):
		case 1: include_once(RELPATH."noauthor_school.php"); break;
		case 2: include_once(RELPATH."noauthor_lessons_ege.php"); break;
	...
	echo "<div class=\"container\">";
		...
		echo "<div class=\"subpage_area\">\n";
			echo "<div class=\"span-16 notopmargin\">\n";
				...
				echo "<p class=\"subpage_descr\">: Для получения более полной информации необходимо войти на сайт.</p>\n";
			echo "</div>\n";
		echo "</div>\n";
		...
		echo "<div class=\"span-16 blog2 notopmargin\">\n";
			...
			echo "<div class=\"span-8 last\">\n";
				...
				echo "<a class=\"button_readmore left\"  href=\"".PAGE_NAME."?div=2&lev=11\"></a>\n";
			echo "</div>\n";
		echo "</div>\n";
		...
		echo "<div>\n";
			...
			echo "<div class=\"span-8 last\">\n";
				...
				echo "<a class=\"button_readmore left\"  href=\"".PAGE_NAME."?div=2&lev=20\"></a>\n";
			echo "</div>\n";
		echo "</div>\n";
		...
		echo "<div>\n";
			...
			echo "<div class=\"span-8 last\">\n";
				...
				echo "<a class=\"button_readmore left\"  href=\"".PAGE_NAME."?div=2&lev=30\"></a>\n";
			echo "</div>\n";
		echo "</div>\n";
	echo "</div>";
